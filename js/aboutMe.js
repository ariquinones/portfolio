function openAboutMe () {
	console.log("toDoList")
		function backHome () {
			...
			mainContainer.innerHTML = 	 	'<div class="mainImageContainer">\
								...
								'<div class="iconsContainer">\
									<img class="iconLink" src="images/aboutIcon.svg">\
		...
		document.querySelector(".mainImageContainer").addEventListener('click', changeToHomePage)
	...
	projectImagesContainer.style.background = 'rgb(41,110,180)' 
	projectImagesContainer.innerHTML = '<h1>About Me</h1>' +
										'<p>Ari C Quiñones Vargas</p>' +
