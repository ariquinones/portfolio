function openBloggingLargeProject () {
	...
	projectDetailsContainer.innerHTML = '<h1 class="projectDescription">App Design</h1>' +
										...
										'<h3 class="projectDetailOverview">A playful and innovative blogging app\
										 to connect users and share their thoughts in a community.</h3>' +
										 '<a href="http://ariquinones.github.io/bloggingPlatformReact/#login" target="_blank"><p>Blogging Large App</p></a>' +
